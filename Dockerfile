...
RUN cd /android/sdk && \
    ...
    ./tools/bin/sdkmanager 'build-tools;27.0.3' 'build-tools;29.0.0' 'build-tools;28.0.3' platform-tools 'platforms;android-28' 'platforms;android-29' 'platforms;android-27' 'platforms;android-26' 'ndk-bundle'
